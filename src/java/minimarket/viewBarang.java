...
public class viewBarang extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet viewBarang</title>");   
            
            out.println("<link rel='StyleSheet' type='text/css' href='http://Piaaasan:8082/resource/file%3A/D%3A/SEMESTER%25205/SISTEM%2520TERDISTRIBUSI/UAS-MINIMARKET/web/styleform.css' media='screen' >");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet viewBarang at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
"    <div class='main'>");
        ...
        //MULAI DARI SINI JAWABNYA
            ...
            out.println("<center><a href=\"product.html\"><button>Tambah Data</button></a></center><br>");
            out.println("<table border='1' align='center'");
            out.println("<tr>");
            out.println("<th>Kode Barang</th>");
            out.println("<th>Nama Barang</th>");
            out.println("<th>Harga</th>");
            out.println("<th>Stok</th>");
            out.println("<th>Merek</th>");
        ...
        while(rs.next()){
            ...
            out.println("<td>" + rs.getString("stok") + "</td>");
            out.println("<td>" + rs.getString("merek") + "</td>");
            out.println("<td>" + rs.getString("kategori") + "</td>");

            out.println("<td style='text-align:center;'>" + "<a href='editBarang?id_barang="+rs.getString("id_barang")+"'><i class='fas fa-edit'></i> </a> | <a href='deleteBarang?id_barang="+rs.getString("id_barang")+"'><i class='fas fa-trash'></i></a></td>");
