...
"    <div class='main'>");
        ...
        //MULAI DARI SINI JAWABNYA
            out.println("<h1 align='center'>Data User</h1>");
            out.println("<center><a href='user.html'><button>Tambah Data</button></a></center><br>");
            out.println("<table border='1' align='center'");
            out.println("<tr>");
            out.println("<th>Kode User</th>");
            out.println("<th>Nama User</th>");
        ...
        while(rs.next()){
            ...
            out.println("<td style='text-align:center;'>" + "<a href='editUser?id_user="+rs.getString("id_user")+"'><i class='fas fa-edit'></i> </a> | <a href='deleteUser?id_user="+rs.getString("id_user")+"'><i class='fas fa-trash'></i></a></td>");
            out.println("</tr>");
        }
            out.println("</table>");
            out.println("</div>");
