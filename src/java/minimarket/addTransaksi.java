...
public class addTransaksi extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet addTransaksi</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet addTransaksi at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
"    <div class='main'>");
        ...
        //MULAI DARI SINI JAWABNYA
            out.println("<h1 align='center'>List Barang Yang Tersedia Barang</h1>");
        ...
        while(rs.next()){
            ...
            out.println("<td style='text-align:center;'>" + "<a href='addProductTransaksi?id_barang="+rs.getString("id_barang")+"'><i class='fas fa-plus' title='Tambah Barang'></i> </a> </td>");
            //out.println("<td>" + "<a href='delete?id_barang="+rs.getString("id_barang")+"'>Delete</td>");
            out.println("</tr>");
        }
            out.println("</table>");
            out.println("<br><a href='addCheckoutTransaksi'><button style='align-items:right;'>Lanjutkan Transaksi</button></a><br>");
            out.println("</div>");
